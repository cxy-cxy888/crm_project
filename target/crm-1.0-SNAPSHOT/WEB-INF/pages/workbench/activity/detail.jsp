...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#saveCreateActivityRemarkBtn").click(function (){
			...
			$.ajax({
				url:'http://localhost:8111/crm/workbench/activity/saveCreateActivityRemark.do',
				data:{
				...
				success:function (data){
					if (data.code=="1") {
						...
						htmlStr+="<h5 id=\"h5_"+data.retData+"\">"+data.retData.noteContent+"</h5>";
						htmlStr+="<font color=\"gray\">市场活动</font> <font color=\"gray\">-</font> <b>${sessionScope.sessionUser.name}</b> <small style=\"color: gray;\">"+data.retData.createTime+"由${sessionScope.sessionUser.name}创建</small>";
		...
		$("#remarkDivList").on("click","a[name='deleteA']",function (){
			...
			$.ajax({
				url:'http://localhost:8111/crm/workbench/activity/deleteActivityRemarkById.do',
				data:{
					id:id
				},
				type: 'post',
		...
		$("#updateRemarkBtn").click(function (){
			...
			$.ajax({
				url:'http://localhost:8111/crm/workbench/activity/saveEditActivityRemark.do',
				data:{
		...
		<c:forEach items="${remarkList}" var="remark">
			<div class="remarkDiv" id="div_${remark.id}" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					...
					<font color="gray">市场活动</font> <font color="gray">-</font> <b>${activity.name}</b> <small style="color: gray;"><c:if test="${remark.editFlag=='1'}">${remark.editTime}</c:if><c:if test="${remark.editFlag!='1'}">${remark.createTime}</c:if>由${remark.editFlag=='1'?remark.editBy:remark.createBy}${remark.editFlag?'修改':'创建'}</small>
