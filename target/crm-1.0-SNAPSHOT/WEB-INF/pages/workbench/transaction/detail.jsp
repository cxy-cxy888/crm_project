		...
		<c:forEach items="${tranRemarkList}" var="tranRemark">
			<div class="remarkDiv" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					...
					<font color="gray">交易</font> <font color="gray">-</font> <b>${tran.name}</b> <small style="color: gray;"><c:if test="${TranRemark.editFlag=='1'}">${TranRemark.editTime}</c:if><c:if test="${TranRemark.editFlag!='1'}">${TranRemark.createTime}</c:if>由${TranRemark.editFlag=='1'?TranRemark.editBy:TranRemark.createBy}${TranRemark.editFlag?'修改':'创建'}</small>
